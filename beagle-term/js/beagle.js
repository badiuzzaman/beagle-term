 ...
 */
Beagle.loadManifest = function(onSuccess, opt_onError) {
 ...
 *     the operation fails.
 */
Beagle.getFileSystem = function(onSuccess, opt_onError) {
 ...
 *     objects to import.
 */
Beagle.importFiles = function(fileSystem, dest, fileList,
